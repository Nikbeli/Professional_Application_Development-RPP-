...
namespace FurnitureAssemblyView
{
    public partial class FormAddFurniture : Form
    {
        ...
        public FormAddFurniture(ILogger<FormAddFurniture> logger, IFurnitureLogic logicFurniture, IShopLogic logicShop)
        {
            InitializeComponent();
        ...
        private void ButtonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _logicFurniture.ReadElement(new FurnitureSearchModel()
                {
